...
public class Main extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnTerminalFiltered = (Button) findViewById(R.id.btnTerminalFiltered);
        btnTerminalFiltered.setOnClickListener(this);

        Button btnFormTracker = (Button) findViewById(R.id.btnFormTracker);
        btnFormTracker.setOnClickListener(this);

        Button btnFormSensor = (Button) findViewById(R.id.btnFormSensor);
        btnFormSensor.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.btnTerminal:
                ...
                startActivity(intent);
                break;
            case R.id.btnTerminalFiltered:
                intent = new Intent(getApplicationContext(), TerminalActivityFiltered.class);
                startActivity(intent);
                break;
            case R.id.btnFormTracker:
                intent = new Intent(getApplicationContext(), FormTrackerActivity.class);
                startActivity(intent);
                break;
            case R.id.btnFormSensor:
                intent = new Intent(getApplicationContext(), FormSensorActivity.class);
                startActivity(intent);
                break;
        }
    }
